        ...
        <div class="wrapper" style="background-image: url('${thisSiteAddress}jsp/stars.png'); left: 300px;">
            <%    
                ...
                for (int i = 1; hiterator.hasNext(); i++) {
                    out.println("<tr align='center'><td><span style='font-family:BankGothic Md BT;font-size:1.3em; color: #090131'>" + i + "</span></td><td><span style='font-family:BankGothic Md BT;font-size:1.3em; color: #090131'>" + hiterator.next() + "</span></td><td><span style='font-family:BankGothic Md BT;font-size:1.3em; color: #090131'>" + hiterator.next() + "</span></td></tr>");
                }
